...
import { AgentsInpuiry, LoginInput, MemberInput, MembersInquiry } from '../../libs/dto/member/member.input';
...
export class MemberService {
  ...
  public async getMember(memberId: ObjectId | null, targetId: ObjectId): Promise<Member> {
    ...
    if (memberId) {
      ...
      // follow
      targetMember.meFollowed = await this.Subscription(memberId, targetId);

    }
    return targetMember;
  }

  private async Subscription(followerId: ObjectId, followingId: ObjectId): Promise<MeFollowed[]> {
